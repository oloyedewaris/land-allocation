    ...
    <div className="reservation-step">
      ...
      <div className="reservation-step-scroll contact-step-scroll">
        <section className="contact-step-intro">
          ...
          <p>
            We will send a six-digit code to confirm this address. Reservation
            documents for unit {unitNumber} will also be sent to the same inbox.
          </p>
        </section>
        ...
        <div className="reservation-field">
          ...
          <input
            ...
            required
          />
          <small id="reservation-email-hint">
            Enter the email address you want to use for this reservation.
          </small>
        </div>
      </div>
