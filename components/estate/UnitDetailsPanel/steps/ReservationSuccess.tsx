  ...
  return loading ? (
    ...
    <div className="reservation-success">
      <div className="reservation-success-scroll">
        ...
        <p>
          Unit {unitNumber} is held in your name for 72 hours. Everything you
          need next is in the message we just sent to <strong>{email}</strong>.
        </p>
        ...
        <ol className="reservation-next-steps">
          <li>
            ...
            <div>
              ...
              <p>
                Review your offer, payment information, terms and reference.
              </p>
            </div>
          </li>
          <li>
            ...
            <div>
              ...
              <p>
                Follow the payment instructions in your email within the 7-day
                offer period.
              </p>
            </div>
          </li>
          <li>
            ...
            <div>
              ...
              <p>
                Once payment is confirmed and the unit is still available, your
      ...
      <footer className="reservation-success-action">
        <a
          className="reservation-open-email"
          href={inboxUrl(email)}
          target="_blank"
          rel="noreferrer"
        >
